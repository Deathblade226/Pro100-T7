...
Color secondary = Color.FromArgb(255, 0, 0, 255);
...
public BrushModifierPanel() {
    ...
    colorPicker.Color = Color.FromArgb((byte)((intColor & 0xff000000) >> 24), (byte)((intColor & 0x00ff0000) >> 16),
    (byte)((intColor & 0x0000ff00) >> 8), (byte)((intColor & 0x000000ff) >> 0));
	}			
	}
